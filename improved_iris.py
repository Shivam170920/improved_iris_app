...
s_len = st.sidebar.slider('Sepel length',float(iris_df['SepalLengthCm'].min()),float(iris_df['SepalLengthCm'].max()))
s_wid = st.sidebar.slider('Sepel width',float(iris_df['SepalWidthCm'].min()),float(iris_df['SepalWidthCm'].max()))
